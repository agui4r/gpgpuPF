...
MAIN = main
OBJS = main.o mult_one_thread_per_tile_in_c_mat.o mult_naive.o mult_2.o mult_tiled_32x32_conventional.o mult_cublas.o mult_one_warp_per_tile.o
...
main.o: main.cu util.cuh mult_one_thread_per_tile_in_c_mat.cuh mult_naive.cuh mult_2.cuh mult_tiled_32x32_conventional.cuh mult_cublas.cuh mult_one_warp_per_tile.cuh
